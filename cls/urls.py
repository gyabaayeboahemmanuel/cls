...
urlpatterns = ( [
    ...
    path('', loginIndex),
    path('#',login_sucess, name='login_sucess'),
    ...
    path('chief_dashboard/', chief_dashboard, name="chief_dashboard"),
    path('chief_statistics/', chief_statistics, name="chief_statistics"),
    path('chief_dashboard/allocation_chit', allocation_chit, name="chief_allocation_chit"),
    path('chief_dashboard/allocation_chit/edit', edit_allocation_chit, name="edit_allocation_chit"),
    path('chief_dashboard/allocation_chit/add', add_allocation_chit, name="add_allocation_chit"),
    ...
    path('dashboard/staff_records/<str:username>/profile/edit', admin_update_staff_profile, name="admin_edit_staffprofile"),
